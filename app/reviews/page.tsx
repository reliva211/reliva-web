                    ...
                    <div className="flex">
                      ...
                      <div className="flex-1 p-3">
                        <div className="flex items-start gap-2 mb-2">
                          ...
                          <div className="flex-1">
                            <h3 className="font-semibold text-sm line-clamp-2">{post.mediaTitle}</h3>
                        ...
                        <div className="space-y-1 text-xs text-muted-foreground">
                          {post.mediaAuthor && (
                            <p>
                              <span className="font-medium">Director:</span> {post.mediaAuthor}
                            </p>
                          )}
                          {post.mediaArtist && (
                            <p>
                              <span className="font-medium">Artist:</span> {post.mediaArtist}
                            </p>
                          )}
                          <p>
                            <span className="font-medium">Year:</span> {post.mediaYear}
                          </p>
                        </div>

                        <div className="mt-2">{renderStarRating(post.rating)}</div>
                      </div>
                    </div>
                  </Card>
                )}
