...
import { Star, Search, Film, Tv, BookOpen, CheckCircle, XCircle } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 max-w-md w-full">
          <h2 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Login Required</h2>
          <p className="text-gray-600 dark:text-gray-300">Please log in to write reviews.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-black dark:to-gray-900 flex items-center justify-center">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Your review has been shared with the community. You'll be redirected to the home page in a few seconds to see it in the feed.
          </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-black dark:to-gray-900">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        <h1 className="text-3xl font-bold mb-8 text-gray-900 dark:text-white">Write a Review</h1>

      {/* Search Section */}
      {!selectedMedia && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-6">
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Search Media</h2>
          </div>
      ...
      {selectedMedia && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Review: {selectedMedia.title}</h2>
          </div>
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              />
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-white">{selectedMedia.title}</h3>
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  {selectedMedia.year && <span>{selectedMedia.year}</span>}
                  {selectedMedia.author && <span> • {selectedMedia.author}</span>}
                </div>
            ...
            {/* Rating */}
            <div>
              <label className="text-sm font-medium text-gray-900 dark:text-white">Rating (1-5 stars) *</label>
              <div className="flex items-center gap-1 mt-2">
                ...
                {rating > 0 && (
                  <span className="ml-2 text-sm text-gray-600 dark:text-gray-300">{rating}/5 stars</span>
                )}
              </div>
            </div>
            ...
            {/* Review Text */}
            <div>
              <label className="text-sm font-medium text-gray-900 dark:text-white">Your Review *</label>
              <textarea
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={!selectedMedia || rating === 0 || !reviewText.trim() || isSubmitting}
