            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-400 md:text-xl">
                  Track your music, books, and movies all in one place. Discover
                  new content and keep a record of your favorites.
                </p>
              </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Tunes and Habits helps you organize your entertainment life
                  with powerful modules.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-4">
              <div className="flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-gray-500 text-center">
                  Listen to your favorite tunes with our Spotify-inspired music
                  player. Create playlists and discover new artists.
                </p>
                <Link
                  href="/music"
              ...
              <div className="flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-gray-500 text-center">
                  Search for books, save your favorites, and keep track of what
                  you've read and what's on your reading list.
                </p>
                <Link
                  href="/books"
                  className="inline-flex items-center text-emerald-600 hover:underline"
              ...
              <div className="flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-gray-500 text-center">
                  Track the movies you've watched, rate them, and build your
                  watchlist for movie nights.
                </p>
                <Link
                  href="/movies"
                  className="inline-flex items-center text-emerald-600 hover:underline"
              ...
              <div className="flex flex-col items-center space-y-4 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-gray-500 text-center">
                  Connect with like-minded people, share recommendations, and
                  discuss your favorite media.
                </p>
                <Link
                  href="/community"
                  className="inline-flex items-center text-emerald-600 hover:underline"
